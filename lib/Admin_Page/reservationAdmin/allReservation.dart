                        ...
                        itemBuilder: (context, index) {
                          ...
                          return ListTile(
                            ...
                            trailing: Column(
                              ...
                              iconPosition: 32,
                              iconColor: status=="En Attente"?Colors.grey:status  == "Expirer"
                                    ?Colors.red:Colors.green,

                              icon: status=="Expirer"?FontAwesomeIcons.xmark: status=="Valider"? FontAwesomeIcons.check  :FontAwesomeIcons.spinner                          // centeralText: "Mukta Ahmed",
