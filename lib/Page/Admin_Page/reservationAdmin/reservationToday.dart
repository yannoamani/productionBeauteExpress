  ...
  Widget build(BuildContext context) {
    return FutureBuilder(
        ...
        builder: (context, snapshot) {
          if (isLoading == false|| snapshot.connectionState == ConnectionState.waiting) {
            return Scaffold(
              appBar: AppBar(),
              body: const Center(
                child: Column(
                                              ...
                                              children: [
                                                ...
                                                Container(
                                                  ...
                                                  child: ElevatedButton(
                                                      ...
                                                      onPressed: btnannulerreservation==true?null:()   async {
                                                        showDialog(
                                                            context: context,
                                                            builder:
                                                                (BuildContext
                                                                ...
                                                                actions: [
                                                                  ...
                                                                  TextButton(
                                                                      onPressed:
                                                                        ...
                                                                        annulerReservation(
                                                                            prefs.getInt('id_valid_reservation')!);
                                                                        reservationsToday();
                                                                      },
                                                                      child: NewText(
                                                                          "Oui",
                                                ...
                                                Container(
                                                  ...
                                                  child: ElevatedButton(
                                                      ...
                                                      onPressed: btnValiderReservation==true?null: () async {
                                                        showDialog(
                                                            context: context,
                                                            builder:
                                                                (BuildContext
