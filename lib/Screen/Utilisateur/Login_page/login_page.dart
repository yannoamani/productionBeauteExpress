...
import 'package:gestion_salon_coiffure/Screen/Utilisateur/Login_page/forgot_password.dart';
import 'package:gestion_salon_coiffure/Screen/Utilisateur/Login_page/inscription.dart';
import 'package:gestion_salon_coiffure/style/Sizeconfig.dart';
import 'package:gestion_salon_coiffure/style/textSize.dart';
                      ...
                      Expanded(
                        ...
                        slivers: [
                          SliverFillRemaining(
                            ...
                            child: Padding(
                              padding:
                                  EdgeInsets.all(getProportionateTextSize(8)),
                              child: Column(
                                mainAxisAlignment: MainAxisAlignment.end,
                                children: [
                                  Text("Bienvenue ",
                                      style: textStyleUtils()
                                          .curenttext(Colors.white, 30)
                                          .copyWith(
