...
import 'package:gestion_salon_coiffure/Screen/Utilisateur/screen/ecranPrincipal/Info_Service.dart';
        ...
        builder: (context, snapshot) {
          ...
          if (snapshot.hasError) {
            ...
            return Scaffold(
                ...
                //   title: Text(
                //     "Recherche",
                //     style: textStyleUtils().curenttext(Colors.black, 20).copyWith(fontWeight: FontWeight.bold),
                //   ),
                // ),
                  ...
                  child: SafeArea(
                    child: CustomScrollView(
                      slivers: [
                            ...
                            children: [
                              ...
                              Autocomplete<String>(
                                ...
                                fieldViewBuilder: (BuildContext context,
                                  ...
                                  return TextField(
                                    style:
                                        monStyle.curenttext(Colors.black, 20),
                        ...
                        tabvide == true
                            ? mesreservations("Aucun service correspondant")
